...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="demo-container">
                                    ...
                                    <div class="form-container active">
                                        ...
                                        <form action="add-card"  method="post" accept-charset="UTF-8" data-parsley-validate="data-parsley-validate" id="payment-form" novalidate="" class="">
            ...
            <script>
                Stripe.setPublishableKey("{{$credential1}}");
                jQuery(function ($) {
